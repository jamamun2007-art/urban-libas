        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-3">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center py-12">
              ...
              <h3 className="font-cinzel text-xl font-bold text-white mb-2">Cart is empty</h3>
              <button onClick={closeCart} className="gold-gradient text-black font-bold px-6 py-3 rounded-full mt-4">
                Continue Shopping
              </button>
            </div>
          ) : (
          ...
          <div className="border-t border-yellow-500/20 p-5 space-y-3">
            {totalSavings > 0 && (
              <div className="flex justify-between text-sm">
                <span className="text-emerald-400">You saved</span>
